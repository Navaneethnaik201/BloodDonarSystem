...
namespace DatabaseLayer1
{
    ...
    public partial class BloodBankDBEntities1 : DbContext
    {
        public BloodBankDBEntities1()
            : base("name=BloodBankDBEntities1")
        {
        }
        ...
        public virtual DbSet<DonarTable> DonarTables { get; set; }
